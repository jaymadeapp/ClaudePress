...
<section class="wp-block-group alignfull has-base-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--40)">
	<!-- wp:paragraph {"className":"cp-reveal","textColor":"secondary","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.1em"},"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}}},"fontSize":"small","fontFamily":"mono"} -->
	<p class="cp-reveal has-secondary-color has-text-color has-link-color has-small-font-size has-mono-font-family" style="letter-spacing:0.1em;text-transform:uppercase">Case study · Meridian</p>
	<!-- /wp:paragraph -->

	<!-- wp:heading {"level":1,"className":"cp-reveal","textColor":"contrast","style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}},"fontSize":"huge","fontFamily":"heading"} -->
	<h1 class="wp-block-heading cp-reveal has-contrast-color has-text-color has-huge-font-size has-heading-font-family" style="margin-top:var(--wp--preset--spacing--20)">Rebuilding a brand for its next <em class="has-display-font-family" style="font-weight:400;color:var(--wp--custom--color--accent-ink, var(--wp--preset--color--accent))">decade</em></h1>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"className":"cp-reveal","textColor":"contrast-2","style":{"spacing":{"margin":{"top":"var:preset|spacing|30"}},"typography":{"lineHeight":"1.6"},"elements":{"link":{"color":{"text":"var:preset|color|contrast-2"}}}},"fontSize":"large","fontFamily":"body"} -->
	...
	<!-- wp:image {"className":"cp-frame cp-reveal","sizeSlug":"large","style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}},"dimensions":{"aspectRatio":"16/9"}}} -->
	<figure class="wp-block-image size-large cp-frame cp-reveal" style="margin-top:var(--wp--preset--spacing--50)"><img src="<?php echo esc_url( get_theme_file_uri( 'images/hero.webp' ) ); ?>" alt="Meridian brand collateral laid out on a warm desk" style="aspect-ratio:16/9;object-fit:cover"/></figure>
	<!-- /wp:image -->
</section>
<!-- /wp:group -->
