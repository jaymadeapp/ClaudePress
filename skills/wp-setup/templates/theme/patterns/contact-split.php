...
<section class="wp-block-group alignfull has-surface-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column" style="flex-basis:44%">
			...
			<p class="cp-reveal has-secondary-color has-text-color has-link-color has-small-font-size has-mono-font-family" style="letter-spacing:0.1em;text-transform:uppercase">Get in touch</p>
			<!-- /wp:paragraph -->
			...
			<h2 class="wp-block-heading cp-reveal has-contrast-color has-text-color has-x-large-font-size has-heading-font-family" style="margin-top:var(--wp--preset--spacing--20)">Let’s <em class="has-display-font-family" style="font-weight:400;color:var(--wp--custom--color--accent-ink, var(--wp--preset--color--accent))">talk</em>.</h2>
			<!-- /wp:heading -->
			...
			<p class="cp-reveal has-contrast-2-color has-text-color has-link-color has-medium-font-size has-body-font-family" style="margin-top:var(--wp--preset--spacing--30);line-height:1.6">Commissions, wholesale, or just to say hello — we read every message and reply within two working days.</p>
			<!-- /wp:paragraph -->

			<!-- wp:group {"className":"cp-contact-details cp-reveal","style":{"spacing":{"margin":{"top":"var:preset|spacing|40"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} -->
			<div class="wp-block-group cp-contact-details cp-reveal" style="margin-top:var(--wp--preset--spacing--40)">
			...
			<!-- wp:buttons {"className":"cp-reveal","style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
			<div class="wp-block-buttons cp-reveal" style="margin-top:var(--wp--preset--spacing--40)">
		...
		<div class="wp-block-column" style="flex-basis:56%">
			<!-- wp:html -->
			<figure class="cp-frame cp-map cp-reveal" style="margin:0">
				<iframe
