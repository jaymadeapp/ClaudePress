...
<section class="wp-block-group alignfull has-base-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			<!-- wp:image {"className":"lk-blob-img lk-reveal","sizeSlug":"large","style":{"dimensions":{"aspectRatio":"1"}}} -->
			<figure class="wp-block-image size-large lk-blob-img lk-reveal"><img src="<?php echo esc_url( get_theme_file_uri( 'images/product-2.webp' ) ); ?>" alt="A row of stoneware mugs in warm earth tones" style="aspect-ratio:1;object-fit:cover"/></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			...
			<p class="lk-reveal has-secondary-color has-text-color has-link-color has-small-font-size has-mono-font-family" style="letter-spacing:0.1em;text-transform:uppercase">The table</p>
			<!-- /wp:paragraph -->
			...
			<h2 class="wp-block-heading lk-reveal has-contrast-color has-text-color has-x-large-font-size has-heading-font-family" style="margin-top:var(--wp--preset--spacing--20)">Tableware that earns its <em class="has-display-font-family" style="font-weight:400;color:var(--wp--custom--color--accent-ink, var(--wp--preset--color--accent))">keep</em>.</h2>
			<!-- /wp:heading -->
			...
			<p class="lk-reveal has-contrast-2-color has-text-color has-link-color has-medium-font-size has-body-font-family" style="margin-top:var(--wp--preset--spacing--30);line-height:1.6">Plates, bowls and cups weighted to feel good in the hand and built to go from oven to table to dishwasher, year after year.</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	</div>
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			<!-- wp:paragraph {"className":"lk-reveal","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.1em"},"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}}},"textColor":"secondary","fontSize":"small","fontFamily":"mono"} -->
			<p class="lk-reveal has-secondary-color has-text-color has-link-color has-small-font-size has-mono-font-family" style="letter-spacing:0.1em;text-transform:uppercase">The bath</p>
			<!-- /wp:paragraph -->

			<!-- wp:heading {"className":"lk-reveal","style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}},"textColor":"contrast","fontSize":"x-large","fontFamily":"heading"} -->
			<h2 class="wp-block-heading lk-reveal has-contrast-color has-text-color has-x-large-font-size has-heading-font-family" style="margin-top:var(--wp--preset--spacing--20)">A softer end to the <em class="has-display-font-family" style="font-weight:400;color:var(--wp--custom--color--accent-ink, var(--wp--preset--color--accent))">day</em>.</h2>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			<!-- wp:image {"className":"lk-blob-img lk-reveal","sizeSlug":"large","style":{"dimensions":{"aspectRatio":"1"}}} -->
			<figure class="wp-block-image size-large lk-blob-img lk-reveal"><img src="<?php echo esc_url( get_theme_file_uri( 'images/lifestyle-2.webp' ) ); ?>" alt="Folded linen towels beside a bar of soap" style="aspect-ratio:1;object-fit:cover"/></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
	</div>
