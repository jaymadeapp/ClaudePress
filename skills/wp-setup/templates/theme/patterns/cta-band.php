...
<section class="wp-block-group alignfull has-primary-background-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-group alignwide" style="position:relative">
		<!-- wp:html -->
		<span class="lk-blob-2" style="position:absolute;right:-6%;top:-32%;z-index:0;width:clamp(140px,18vw,260px);aspect-ratio:1;background:var(--wp--custom--color--on-primary, var(--wp--preset--color--base));opacity:.14;pointer-events:none" aria-hidden="true"></span>
		<!-- /wp:html -->
		...
		<div class="wp-block-group" style="flex-basis:min(100%, 36rem)">
			...
			<p class="lk-reveal has-secondary-color has-text-color has-link-color has-small-font-size has-mono-font-family" style="letter-spacing:0.1em;text-transform:uppercase">Begin the ritual</p>
			<!-- /wp:paragraph -->

			<!-- wp:heading {"className":"lk-reveal","style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}},"textColor":"base","fontSize":"xx-large","fontFamily":"heading"} -->
			<h2 class="wp-block-heading lk-reveal has-base-color has-text-color has-xx-large-font-size has-heading-font-family" style="margin-top:var(--wp--preset--spacing--20)">Bring a little more calm <em class="has-display-font-family" style="font-weight:400;color:var(--wp--custom--color--on-primary, var(--wp--preset--color--base))">home</em>.</h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"className":"lk-reveal","style":{"spacing":{"margin":{"top":"var:preset|spacing|30"}},"typography":{"lineHeight":"1.6"},"elements":{"link":{"color":{"text":"var:preset|color|surface"}}}},"textColor":"surface","fontSize":"large","fontFamily":"body"} -->
			<p class="lk-reveal has-surface-color has-text-color has-link-color has-large-font-size has-body-font-family" style="margin-top:var(--wp--preset--spacing--30);line-height:1.6">Start with one piece you'll use every day. We'll take it from there.</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->

		<!-- wp:buttons {"className":"lk-reveal","layout":{"type":"flex"}} -->
		<div class="wp-block-buttons lk-reveal">
			...
			<!-- wp:button {"className":"lk-cta-pill","style":{"border":{"radius":"var:custom|radius|pill"},"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"fontFamily":"heading"} -->
			<div class="wp-block-button lk-cta-pill has-custom-font-size has-heading-font-family"><a class="wp-block-button__link wp-element-button lk-cta-pill" style="border-radius:var(--wp--custom--radius--pill);padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--50);background-color:var(--wp--custom--color--on-primary, var(--wp--preset--color--base));color:var(--wp--preset--color--primary)">Shop the collection</a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	</div>
