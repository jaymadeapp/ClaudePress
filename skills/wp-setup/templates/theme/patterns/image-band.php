...
<section class="wp-block-group alignfull has-surface-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:54%">
			<!-- wp:image {"className":"cp-frame cp-reveal","sizeSlug":"large","style":{"dimensions":{"aspectRatio":"4/3"}}} -->
			<figure class="wp-block-image size-large cp-frame cp-reveal"><img src="<?php echo esc_url( get_theme_file_uri( 'images/lifestyle-1.webp' ) ); ?>" alt="Hands shaping clay on a potter's wheel" style="aspect-ratio:4/3;object-fit:cover"/></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:46%">
			...
			<p class="cp-reveal has-secondary-color has-text-color has-link-color has-small-font-size has-mono-font-family" style="letter-spacing:0.1em;text-transform:uppercase">Made by hand</p>
			<!-- /wp:paragraph -->
			...
			<!-- wp:paragraph {"className":"cp-reveal","style":{"spacing":{"margin":{"top":"var:preset|spacing|30"}},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontSize":"medium","fontFamily":"heading"} -->
			<p class="cp-reveal has-primary-color has-text-color has-link-color has-medium-font-size has-heading-font-family" style="margin-top:var(--wp--preset--spacing--30)"><a href="#">Visit the studio →</a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	</div>
