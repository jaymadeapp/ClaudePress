 ...
 * Keywords: logos, clients, partners, brands, trust, as seen in
 * Viewport Width: 1280
 */
?>
...
<section class="wp-block-group alignfull has-surface-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-columns are-vertically-aligned-center lk-reveal">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<p class="has-text-align-center has-contrast-color has-text-color has-link-color has-large-font-size has-heading-font-family">Toast</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center">
			<!-- wp:paragraph {"align":"center","textColor":"contrast","style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"fontSize":"large","fontFamily":"heading"} -->
			<p class="has-text-align-center has-contrast-color has-text-color has-link-color has-large-font-size has-heading-font-family">Maker &amp; Moss</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center">
			<!-- wp:paragraph {"align":"center","textColor":"contrast","style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"fontSize":"large","fontFamily":"heading"} -->
			<p class="has-text-align-center has-contrast-color has-text-color has-link-color has-large-font-size has-heading-font-family">The Hearth</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center">
			<!-- wp:paragraph {"align":"center","textColor":"contrast","style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"fontSize":"large","fontFamily":"heading"} -->
			<p class="has-text-align-center has-contrast-color has-text-color has-link-color has-large-font-size has-heading-font-family">Folk</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center">
			<!-- wp:paragraph {"align":"center","textColor":"contrast","style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"fontSize":"large","fontFamily":"heading"} -->
			<p class="has-text-align-center has-contrast-color has-text-color has-link-color has-large-font-size has-heading-font-family">Cedar House</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	</div>
