<?php
/**
 * Title: ClaudePress — Hero (Centered)
 * Slug: claudepress/hero-centered
 * Categories: claudepress, featured, banner
 * Block Types:
 * Inserter: true
 * Description: A centered hero with eyebrow, large headline, supporting paragraph, and two call-to-action buttons on a soft surface background.
 * Keywords: hero, header, banner, intro, headline
 * Viewport Width: 1280
 */
?>
...
<section class="wp-block-group alignfull has-surface-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--40)">
	...
	<p class="has-text-align-center has-primary-color has-text-color has-link-color has-small-font-size has-heading-font-family" style="letter-spacing:0.08em;text-transform:uppercase">Built for modern teams</p>
	<!-- /wp:paragraph -->

	<!-- wp:heading {"textAlign":"center","level":1,"textColor":"contrast","fontSize":"huge","fontFamily":"heading"} -->
	<h1 class="wp-block-heading has-text-align-center has-contrast-color has-text-color has-huge-font-size has-heading-font-family">Everything your business needs to grow online</h1>
	<!-- /wp:heading -->
	...
	<p class="has-text-align-center has-contrast-2-color has-text-color has-link-color has-large-font-size has-body-font-family" style="margin-top:var(--wp--preset--spacing--30)">Launch a polished, fast website your customers trust — and update it yourself in minutes, no developer required.</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--40)">
		...
		<div class="wp-block-button"><a class="wp-block-button__link has-base-color has-primary-background-color has-text-color has-background has-link-color wp-element-button">Get started</a></div>
		<!-- /wp:button -->

		<!-- wp:button {"textColor":"primary","className":"is-style-outline","style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}}} -->
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-primary-color has-text-color has-link-color wp-element-button">See how it works</a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</section>
